...
class AIAdapter  extends RecyclerView.Adapter<AIAdapter.MyViewHolder>{
    ...
    public AIAdapter(Button6Activity button6Activity, List<MyResource> resourceList) {
        list = resourceList;
        ct = button6Activity;
    }
    @Override
    public AIAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(ct).inflate(R.layout.row,parent,false);
        return new AIAdapter.MyViewHolder(v);
    }
