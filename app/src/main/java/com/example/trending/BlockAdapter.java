...
class BlockAdapter  extends RecyclerView.Adapter<BlockAdapter.MyViewHolder>{
    Context ct;
    List<MyResource> list;
    public BlockAdapter(Button8Activity button8Activity, List<MyResource> resourceList) {
        list = resourceList;
        ct = button8Activity;
    }
    @Override
    public BlockAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new BlockAdapter.MyViewHolder(v);
    }
